...
<body>
	<div class="container">
		...
		<div id="register-sec" class="row">Register
			<form role="form" class="form-horizontal" id="register" action="/pokes/reg_validation" name="action" value="register" method="post">
		...
		<div id="login-sec" class="row">Login
			<form role="form" class="form-horizontal" id="login" action="/pokes/login_validation" name="action" value="login" method="post">
